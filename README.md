# Résumé du cours GEOL-F103 - Problèmes actuels de la gestion de l'énergie

## Qu'est-ce donc ce répertoire ?
Ce répertoire contient le résumé en PDF (via LaTeX) du cours GEOL-F103 - Problèmes actuels de la gestion de l'énergie de l'Université Libre de Bruxelles. Ce résumé dispose de la même table des matières que le cours (dans la mesure du possible).
